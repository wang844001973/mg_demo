...
<%
	Boolean isSuccess = (Boolean)request.getSession(false).getAttribute("isSuccess");
%>
<html>
<head>
		...
		<tr>
			<td>
				<table class="context_table" width="100%">
					...
					<%
						Map certAttributeNodeMap = (Map) request.getSession()
								.getAttribute("certAttributeNodeMap");
						Map pmsAttributeNodeMap = (Map) request.getSession()
								.getAttribute("pmsAttributeNodeMap");
						Map umsAttributeNodeMap = (Map) request.getSession()
								.getAttribute("umsAttributeNodeMap");
						Map customAttributeNodeMap = (Map) request.getSession()
					...
					<%
							...
							String errCode = (String) request.getSession().getAttribute("errCode");
							String errDesc = (String) request.getSession().getAttribute("errDesc");
